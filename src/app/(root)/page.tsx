  ...
  return (
    <main>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <Link href="mailto:skr.04088s@gmail.com" target="_blank">
              <Button
                ...
                className="w-48 px-6 py-2 font-medium transition-all duration-300 hover:-translate-y-0.5"
              >
                <Mail />
                Hire me
              </Button>
            ...
            <div className="flex gap-2">
              {/* GitHub */}
              <Link href="https://github.com/Sumit262601" target="_blank">
                <Button
                  variant="outline"
                  size="icon"
      ...
      <section id="skills" className="container">
        <h2 className="text-3xl font-bold text-center tracking-tighter sm:text-4xl mb-12">
          Technology Stack
        </h2>
