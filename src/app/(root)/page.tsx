...
export default function Page() {
  ...
  return (
    <main>
      ...
      {/* About */}
      <section id="about" className="mx-auto max-w-4xl text-center py-24 lg:py-40">
        <div className="flex flex-col space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
              Hello User&apos;s
              <span className="text-4xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">👋</span>
            </h1>
              {/* <span className="flex justify-center items-center text-4xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">F */}
          ...
          <div className="flex gap-4 justify-center items-center">
            <Link href="mailto:skr.04088s@gmail.com" target="_blank">
            ...
            <div className="space-x-2">
              {/* Github */}
              <Link
                href="https://github.com/Sumit262601"
                target="_blank"
              >
                <Button
                  variant="outline"
                  ...
                  className="transform px-6 py-2 font-medium transition-all duration-300 hover:-translate-y-0.5"
                >
              ...
              {/* LinkedIn */}
              <Link
                href="https://www.linkedin.com/in/sumit-k-bb4381250/"
                target="_blank"
              >
                <Button
                  variant="outline"
